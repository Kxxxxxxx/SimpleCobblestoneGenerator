...
public final class RegistrationHandler {
	...
	public static void registerBlocks(final RegistryEvent.Register<Block> event) {
		...
		final int registryCountBefore = registry.getValues().size();
		...
		Log.info("Added %d block entries to Registry.", registry.getValues().size() - registryCountBefore);
	...
	public static void registerItemBlocks(final RegistryEvent.Register<Item> event) {
		...
		// log the amount of blocks registered
		Log.info("Added %d item entries to Registry.", registry.getValues().size() - registryCountBefore);
